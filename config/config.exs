...
config :rest_ful_point, RestFulPointWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: RestFulPointWeb.ErrorHTML, json: RestFulPointWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: RestFulPoint.PubSub,
  live_view: [signing_salt: "eGYfAUC8"]

config :rest_ful_point,
  ecto_repos: [RestFulPoint.Repo],
